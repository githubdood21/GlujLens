...
public partial class SettingsView : Window
{
    ...
    private void OnKeyDown(object? sender, KeyEventArgs e)
    {
        ...
        // Prevent default handling while recording
        e.Handled = true;
    }
    ...
    private void OnKeyUp(object? sender, KeyEventArgs e)
    {
        ...
        // Build the shortcut string from the released key and any held modifiers
        ...
        var fullShortcut = parts.Count > 0 ? string.Join("+", parts) + "+" + keyName : keyName;

        // Save the shortcut and stop recording
        _settingsVm?.OnKeyCaptured(fullShortcut);
